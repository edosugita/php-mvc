        ...
        <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="jurusan" name="jurusan">
              ...
              <option value="Teknik Mesin" disabled>Teknik Mesin</option>
              <option value="Teknik Industri" disabled>Teknik Industri</option>
              <option value="Teknik Pangan" disabled>Teknik Pangan</option>
              <option value="Teknik Planologi" disabled>Teknik Planologi</option>
              <option value="Teknik Lingkungan" disabled>Teknik Lingkungan</option>
            </select>
          </div>
